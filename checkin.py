...
class HOTEL_MANGMENT_checkin:
    ...
    def __init__(self):
        ...
        self.Message6.place(relx=0.415, rely=0.3,
                            relheight=0.09, relwidth=0.04)
        ...
        self.var1 = IntVar()
        self.Checkbutton1.place(relx=0.15, rely=0.58,
                                relheight=0.17, relwidth=0.14)
        ...
        self.var2 = IntVar()
        self.Checkbutton2.place(relx=0.15, rely=0.72,
                                relheight=0.11, relwidth=0.21)
        ...
        self.var3 = IntVar()
        self.Checkbutton3.place(
            relx=0.5, rely=0.6, relheight=0.11, relwidth=0.16)
        ...
        self.var5 = IntVar()
        self.Checkbutton5.place(relx=0.485, rely=0.89,
        ...
        self.var6 = IntVar()
        self.Checkbutton6.place(relx=0.153, rely=0.89,
